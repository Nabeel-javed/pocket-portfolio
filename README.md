...
- The green handset opens Contact. The red handset returns home.
- Star cycles Silver, Graphite, and Champagne finishes. Hash toggles sound, which defaults to off.
